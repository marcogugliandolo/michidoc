            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <div className="text-[13px] font-semibold text-neutral-900 dark:text-white truncate max-w-[90px] leading-tight">
                    {profile.name}
                  </div>
                </div>
              </button>
              ...
              <button
                onClick={onReset}
                className="p-2 rounded-full text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors cursor-pointer"
                title="Cerrar sesión"
              >
                <LogOut size={18} />
              </button>
